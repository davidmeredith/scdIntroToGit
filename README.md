...
Note: The repository that demostrates the tools featured in the [IntroToGitHubTools](https://github.com/davidmeredith/scdIntroToGit/blob/master/IntroToGitHubTools.pdf) talk can be found [here](https://github.com/tofu-rocketry/tool-test).
